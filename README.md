...
ابدأ من [دليل التوثيق](docs/README.md)، ثم راجع [خريطة التحديث والاتساق](docs/documentation-update-map.md) لفهم العلاقة بين كل ملف، والقرار الذي يثبته، والرسم المناسب له. وللاطلاع على المشاكل المرصودة وخطة النسخة القادمة، راجع [وثيقة المشاكل والحلول المقترحة](docs/current-issues-next-version-plan-ar.md).
