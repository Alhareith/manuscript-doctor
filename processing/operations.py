...
OPERATIONS.update(
    {
        "erosion": {
            ...
            "name": "Erosion",
            "category": "morphology",
            "purpose": "تقليص بنى الحبر الداكنة وترقيقها",
            "description": "تآكل بنيوي يَعتبر الحبر الداكن هو المقدمة، وهو الأنسب لوثائق النص الداكن على ورق فاتح.",
            "risk": "high",
            "automatic": False,
        ...
        "dilation": {
            ...
            "name": "Dilation",
            "category": "morphology",
            "purpose": "توسيع بنى الحبر الداكنة وتثخينها",
            "description": "توسيع بنيوي يَعتبر الحبر الداكن هو المقدمة، وهو الأنسب لوثائق النص الداكن على ورق فاتح.",
            "risk": "high",
            "automatic": False,
            "default_parameters": {"kernel_size": 3, "iterations": 1},
        },
        ...
        "laplacian_sharpen": {
            ...
            "description": "شحذ لابلاسيان قياسي بطرح الاستجابة الموقعة من قناة الإضاءة.",
            "risk": "medium",
            "automatic": False,
        ...
        "log_transform": {
            ...
            "description": "تحويل لوغاريتمي ثابت المجال يحافظ على نقطتي 0 و255 ويغير انحناء التحويل بمعامل الشدة.",
            "risk": "low",
            "automatic": False,
